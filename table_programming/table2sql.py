...
def test(train_encoder_file,train_decoder_file,test_encoder_file,test_decoder_file,save_pre_file,engine,data_type,model_type,limit_table, nshot):
    ...
    for i, question in enumerate(pbar):
        ...
        pre_text = 'Please generate VQL based on DDL table and question.'
        pre_code = ""
        ...
        prompt = pre_text + 'This is an example: \n' + example_data + 'Now, please generate VQL to answer this question based on DDL table. Gnerate VQL in one line and begin with : visulaize\n' + db + question
        print(prompt)
        ...
        if count % 300 == 0:
            save_data(generated_answers, f'{model_type}_{data_type}_create_select_data{limit_table}_{nshot}shot_{count}.txt')
...
if __name__ == "__main__":
    ...
    save_pre_file = f'{model_type}_{data_type}_create_select_data{limit_table}_{nshot}shot_total.txt'
    print(save_pre_file)
